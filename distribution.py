# Модуль для работы с распределениями случайной величины.
# Реализованы функции для расчета характеристик распределения.
# Так же реализованы функции для моделирования случайной величины следю законов распределения:
#    - Нормальный
#    - Логарифмически нормальный
#    - Равномерный
#    - Бирнабаума-Саундерса
#    - Парето
#    - Гамма распределение
import random
import math
